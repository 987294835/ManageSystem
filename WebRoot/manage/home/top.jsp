...
#Head_1 {
    background: url("../../css/images/index/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
    height: 64px;
    margin: 0 auto;
    width: 100%;
}
...
#Head_2 {
   background: url("../../css/images/index/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
...
<body>
	...
	<div id="Head_1">
		...
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">无线点餐系统后面管理中心</b> <!-- <img border="0" src="style/blue/images/logo.png" /> -->
        </div>
		
		<!-- 欢迎用户的文字 -->
		<div id="Head_1_UserWelcome">
			<img border="0" width="13" height="14" src="../../css/images/index/user.gif" /> 
			您好，<b>管理员</b>
		</div>
		...
		<div id="Head_1_FunctionButton">
			<a target="right" href="javascript:void(0)">
				<img width="78" height="20" src="../../css/images/index/help2.gif" />
			</a>
			<a target="_parent" href="javascript:void(0)">
				<img width="78" height="20" alt="退出系统" src="../../css/images/index/logout.gif" />
			</a>
		</div>
    ...
    <div id="Head_2">
        ...
        <div id="Head2_Awoke">
			...
			<ul id="AwokeNum">
                ...
                <li>
					<a target="right" href="javascript:void(0)">
						<img border="0" src="../css/images/index/msg.gif" /> 消息
						<span id="my_msg">0</span>
					</a>
				</li>
                <li class="Line"></li>
                <li><a target="right" href="javascript:void(0)">
						<img border="0" src="../css/images/index/mail.gif" align="texttop"/> 邮件
						<span id="my_mail">0</span>
					</a>
				</li>
                <li class="Line"></li>
				<li><a href="../manage/home/Flow_Formflow/myTaskList.jsp" target="right">
                		<img border="0" src="../css/images/index/wait.gif" /> 待办事项
						<span id="my_task">0</span>
                	</a>
                </li>
				-->
		...
		<div class="Head2_FunctionList" style="float:left">
			<a href="javascript: window.parent.right.history.back();">
				<img src="../../css/images/Header_back.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>后退</b>
			</a>
			<a href="javascript: window.parent.right.history.forward();">
				<img src="../../css/images/Header_forward.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>前进</b>		
			</a>
        </div>
		...
		<div id="Head2_FunctionList">
			...
			<a href="javascript: window.parent.right.history.go(0);">
				<img src="../../css/images/Header_refresh.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>刷新(IE、Chrome)</b>		
			</a>
