...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="../../css/images/title_arrow.gif"/>  保存菜系信息
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="<%= basePath%>foodType/addFoodTypeServlet" method="post">
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							...
							<td>
							   <input type="text" name="loginName" class="InputStyle"/> *
							</td>
						</tr>
